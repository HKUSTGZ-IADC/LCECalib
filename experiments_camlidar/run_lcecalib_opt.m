function run_lcecalib_opt(all_iterations, edge_iterations, start_frame, end_frame)
  ...
  sprintf('r_err: %f, t_err: %f, mp_err: %f of initial estimated TF', r_err, t_err, min_error)  
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  sprintf('r_err: %f, t_err: %f, mp_err: %f of final estimated TF', r_err, t_err, tmp_mp_err)  
