...
numH = 7;
numW = 9;
save('data/simu_data/simu_data_1/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight');
save('data/simu_data/simu_data_2/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight');
save('data/simu_data/simu_data_3/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight');
...
numH = 7;
numW = 9;
save('data/real_data/real_data_1/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('data/real_data/real_data_2/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('data/real_data/real_data_3/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
...
numH = 7;
numW = 10;
save('real_data/real_data_4/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', ...
  'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('real_data/real_data_5/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', ...
  'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
...
imageWidth = 346;
imageHeight = 260;
save('real_data/real_data_9/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', ...
  'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('real_data/real_data_5/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', ...
  'pattern_size', 'squareSize', ...
...
imageWidth = 1024;
imageHeight = 768;
save('fp_data/real_data_1/frame_img/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
             
%% fp_data/real_data_1/event_image
...
imageWidth = 346;
imageHeight = 260;
save('fp_data/real_data_1/event_img/params.mat', 'K', 'D', 'borH', 'borW', 'numH', 'numW', ...
  'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
