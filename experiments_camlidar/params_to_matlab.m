...
edge_weight = 3.0;
planar_weight = 1.0;
save('data/simu_data/simu_data_bias_1/img/params.mat', 'K', 'D', 'borH', 'borW', ...
...
save('data/simu_data/simu_data_bias_2/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_3/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_4/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_5/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_6/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_7/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_8/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_9/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
save('data/simu_data/simu_data_bias_10/img/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', 'checkerboardPadding', 'TGt', ...
  'num_data', 'imageWidth', 'imageHeight', ...
  'use_edge_flag', 'use_planar_flag', ...
  'edge_weight', 'planar_weight');
