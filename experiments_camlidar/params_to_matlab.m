...
numH = 7;
numW = 9;
save('simu_data/params.mat', 'K', 'D', 'borH', 'borW', ...
...
numH = 7;
numW = 9;
save('real_data/real_data_1/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('real_data/real_data_2/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
save('real_data/real_data_3/params.mat', 'K', 'D', 'borH', 'borW', ...
  'numH', 'numW', 'pattern_size', 'squareSize', ...
  'checkerboardPadding', 'TGt', 'num_data', 'imageWidth', 'imageHeight');
